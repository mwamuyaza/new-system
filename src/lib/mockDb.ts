...
const DEFAULT_DB_STATE = (): MockDbState => ({
  users: [
   { id: 1, username: 'admin', password: 'admin', email: 'mosesmwamuye97@gmail.com', role: 'ADMIN', isActive: true, createdAt: '2026-01-01T00:00:00.000Z' },
{ id: 2, username: 'john.staff', password: 'password', email: 'john@university.com', role: 'STAFF', isActive: true, createdAt: '2026-01-01T00:00:00.000Z' },
   { id: 3, username: 'jane.student', password: 'password', email: 'jane@university.com', role: 'STUDENT', isActive: true, createdAt: '2026-01-01T00:00:00.000Z' },
   { id: 4, username: 'robert.staff', password: 'password', email: 'robert@university.com', role: 'STAFF', isActive: true, createdAt: '2026-01-01T00:00:00.000Z' },
   { id: 5, username: 'isaac.staff', password: 'password', email: 'isaac@university.com', role: 'STAFF', isActive: true, createdAt: '2026-01-01T00:00:00.000Z' },
    { id: 6, username: 'richard.staff', password: 'password', email: 'richard@university.com', role: 'STAFF', isActive: true, createdAt: '2026-01-01T00:00:00.000Z' },
  ],
  students: [
    {
      id: 1,
